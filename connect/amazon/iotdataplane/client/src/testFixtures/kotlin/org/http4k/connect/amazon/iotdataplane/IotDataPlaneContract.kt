...
interface IotDataPlaneContract : AwsContract {
    /** Account-specific IoT data endpoint. */
    val endpoint: Uri
    ...
    /** Avoids assumptions about other messages in the account. */
    @Test
    ...
    /** Follows one page because the account-wide store is unbounded. */
    @Test
